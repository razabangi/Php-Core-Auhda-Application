...
<div class="col-sm-6">	<!-- col/sm-6-start -->
	...
	<h3 class="profit-heading">Partner Ledger</h3>
...
<div class="row mb-30"><!-- start row -->
<div class="col-sm-12"><!-- Start Coloum -->


<h3 class="heading-p">Partner Ledger</h3>
...
<div class="table-responsive">
  <table class="table">
    <tr style="border-bottom:1px solid #666; color:#666;">
      <td><strong>JRNL</strong></td>
      <td><strong>Account</strong></td>
      <td><strong>Ref</strong></td>
      <td><strong>Matching Number</strong></td>
      <td><strong>Debit</strong> </td>
      <td><strong>Credit</strong></td>
      <td><strong>Balnce</strong></td>

    </tr>

<tr style="border-bottom:1px solid #666; color:#666;">
      <td><li role="presentation" class="dropdown list-unstyled">
<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
     <span class="caret"></span><strong>GFC  </strong> 
    </a>
    <ul class="dropdown-menu">
     <li><a href="#">action </a></li>
     <li><a href="#">Random </a></li>
    ...
    <tr style="border-bottom:1px solid #666; color:#666;">
      <td><li role="presentation" class="dropdown list-unstyled">
<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
     <span class="caret"></span><strong>Mr Saleem  </strong> 
    </a>
    <ul class="dropdown-menu">
     <li><a href="#">action </a></li>
     <li><a href="#">Random </a></li>
    ...
    <tr style="border-bottom:1px solid #666; color:#666;">
      <td><li role="presentation" class="dropdown list-unstyled">
<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
     <span class="caret"></span><strong>Mr Shariq  </strong> 
    </a>
    <ul class="dropdown-menu">
     <li><a href="#">action </a></li>
     <li><a href="#">Random </a></li>
