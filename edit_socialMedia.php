...
$query = $con->prepare("select * from tbl_social_media where id = '$edit'");
...
<ul class="nav navbar-nav navbar-left mynave">
	<li><a href="#"><p class="main-heading22"><strong>Social Media Info &nbsp;</strong><span>/&nbsp;New</span></p>
</a></li>
...
<form action="update_socialMediaInfo.php" method="POST">
...
<div class="col-sm-9">
 ...
 <input type="text" name="first_name" value="<?php echo $fetch['first_name']; ?>" required="" id="first_name" placeholder="First Name" class="myform-control-d">

  <input type="text" value="<?php echo $fetch['last_name']; ?>" name="last_name" required="" id="last_name" placeholder="Last Name" class="myform-control-d">

 <input type="text" value="<?php echo $fetch['institute']; ?>" name="insitute" required="" id="insitute" placeholder="Insititute" class="myform-control-d">
...
<div class="col-sm-9">
 ...
 <input type="text" value="<?php echo $fetch['designation']; ?>" name="designation" required="" id="designation" placeholder="Designation" class="myform-control-d">

 <input type="email" value="<?php echo $fetch['email']; ?>" name="email_id" required="" id="email_id" placeholder="Email Address" class="myform-control-d">
