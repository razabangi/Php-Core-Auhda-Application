...
<div class="col-sm-12">
<div id="Page_wrap">
<form action="act_companiesInfo.php" method="POST">
      <div class="head-top">
...
<li><a href="#"><p class="main-heading22"><strong>Companies Information &nbsp;</strong><span>/&nbsp;New</span></p>
</a></li>
   ...
   <ul class="nav nav-tabs navbar-right mynave newnav">
    <li class="active"><a data-toggle="tab" href="#home">Create Company Information</a></li>
    <li><a  data-toggle="tab" href="#menu13"><span class="fa fa-trash"></span>Show Companies Information</a></li>
    </ul>
...
<div class="col-sm-6">
<div class="form-group">
<div class="col-sm-3"><label class="newlabels">Designation</label><br><label class="newlabels">Ext No</label><br><label class="newlabels">Direct No</label></div>
<div class="col-sm-9">
 <input type="text" required="" name="designation" id="designation" placeholder="Designation" class="myform-control-d">

  <input type="text" required="" name="ext_no" id="ext_no" placeholder="Ext No" class="myform-control-d">

 <input type="text" required="" name="direct_no" id="amount" placeholder="Direct No" class="myform-control-d">
  ...
  <div class="col-sm-6">
<div class="form-group">
<div class="col-sm-3"><label class="newlabels">Fax No</label><br><label class="newlabels">Email</label></div>
<div class="col-sm-9">

 <input type="text" required="" name="fax_no" id="fax_no" placeholder="Fax No" class="myform-control-d">

<input type="text" required="" name="email" id="email" placeholder="Email" class="myform-control-d">
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo $row['email']; ?></td>
                             <td><a href="edit_company.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a></td>
