...
<?php include("partial/header.php"); ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
  <form name="add_client" id="add_client" method="POST" action="act_socialMediaInfo.php" class="form-group">
     <div class="col-sm-6">
  ...
  <div class="form-group">
    ...
    <input type="text" required="" class="form-control" name="insitute" id="insitute" placeholder="Institute">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required="" name="email_id" class="form-control" id="email_id" placeholder="Email Address">
  </div>
  </div>
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo $row['email']; ?></td>
                             <td><a href="socialMedia_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a></td>
