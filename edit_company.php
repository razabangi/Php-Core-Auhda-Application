...
<ul class="nav navbar-nav navbar-left mynave">
	<li><a href="#"><p class="main-heading22"><strong>Company Info &nbsp;</strong><span>/&nbsp;New</span></p>
</a></li>
...
<form action="update_companiesInfo.php" method="POST">
...
<div class="col-sm-9">
 ...
 <input type="text" name="designation" value="<?php echo $fetch['designation']; ?>" required="" id="designation" placeholder="Designation" class="myform-control-d">
  ...
  <input type="text" name="ext_no" value="<?php echo $fetch['ext_no']; ?>" required="" id="ext_no" placeholder="Ext No" class="myform-control-d">

 <input type="text" name="direct_no" value="<?php echo $fetch['direct_no']; ?>" required="" id="amount" placeholder="Direct No" class="myform-control-d">
...
<div class="col-sm-9">
 ...
 <input type="text" name="fax_no" id="fax_no" value="<?php echo $fetch['fax_no']; ?>" required="" placeholder="Fax No" class="myform-control-d">

<input type="email" name="email" id="email" value="<?php echo $fetch['email']; ?>" required="" placeholder="Email" class="myform-control-d">
