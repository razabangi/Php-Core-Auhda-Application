...
<?php include("partial/header.php"); ?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
  <form name="add_client" id="add_client" method="POST" action="act_pitchUniversitiesInfo.php" class="form-group">
     <div class="col-sm-6">
  <div class="form-group">
    <label for="uni_name">Name Of University:</label>
    <input type="text" required="" class="form-control" id="uni_name" placeholder="Name Of University" name="uni_name">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required="" class="form-control" id="authorised_person" placeholder="Authorised Person" name="authorised_person">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required="" class="form-control" name="referred_person" id="referred_person" placeholder="Referred Person">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required="" name="designation" class="form-control" id="designation" placeholder="Designation">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="email" required="" name="email_id" class="form-control" id="email_id" placeholder="Email Address">
  </div>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" required="" name="status" class="form-control" id="status" placeholder="Status">
  </div>
  </div>
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo $row['status']; ?></td>
                             <td><a href="pitchedUniversity_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a></td>
